...
public class OffreetServiceValideretRefuserAdapterActivity extends RecyclerView.Adapter<OffreetServiceValideretRefuserAdapterActivity.MyViewHolder> {
    ...
    public OffreetServiceValideretRefuserAdapterActivity(List<ServiceStatut> personList,Context context) {
    ...
    @NonNull
    @Override
    public OffreetServiceValideretRefuserAdapterActivity.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_offreet_service_valideret_refuser_adapter,parent,false);
        return new OffreetServiceValideretRefuserAdapterActivity.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final OffreetServiceValideretRefuserAdapterActivity.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull final View itemView) {
            super(itemView);
            root_view = (CardView)itemView.findViewById(R.id.root_viewoffetservicevetr);
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offreet_service_valideret_refuser_adapter);
        }
*/